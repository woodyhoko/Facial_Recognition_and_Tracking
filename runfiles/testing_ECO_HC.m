function results = testing_ECO_HC(seq, debugshow,debuginfo, BB, cam, videoPlayer,res_path, bSaveImage, parameters)
...
params.debug = debuginfo;                       % Do full debug visualization
...
% Run tracker
results = track_i(params,debugshow,BB,cam,videoPlayer);
