function results = tracker(params,debugshow)
...
%ppp={base_target_sz, block_inds, CG_opts, cos_window, currentScaleFactor, debugshow, distance_matrix, feature_dim, feature_extract_info, feature_info, feature_params, feature_sz, feature_sz_cell, features, filter_sz, filter_sz_cell, frames_since_last_train, global_fparams, gram_matrix, img_sample_sz, img_support_sz, init_CG_opts, init_target_sz, interp1_fs, interp2_fs, is_color_image, k, k1, kx, ky, latest_ind, max_scale_factor, min_scale_factor, nScales, num_feature_blocks, num_training_samples, output_sz, pad_sz, params, pos, prior_weights, reg_energy, reg_filter, reg_window_edge, res_norms, sample_dim, sample_weights, samplesf, scale_filter, scale_step, scaleFactors, scores_fs_feat, search_area, seq, sig_y, target_sz, yf, yf_x, yf_y};

%base_target_sz, block_inds, CG_opts, CG_state, cos_window, currentScaleFactor, debugshow, distance_matrix, feature_dim, feature_extract_info, feature_info, feature_params, feature_sz, feature_sz_cell, features, fig_handle, filter_sz, filter_sz_cell, frames_since_last_train, global_fparams, gram_matrix, hf, hf_full, img_sample_sz, img_support_sz, init_CG_opts, init_target_sz, interp1_fs, interp2_fs, is_color_image, k, k1, kx, ky, latest_ind, max_scale_factor, merged_sample, merged_sample_id, min_scale_factor, new_sample, new_sample_energy, new_sample_id, new_train_sample_norm, nScales, num_feature_blocks, num_training_samples, output_sz, pad_sz, params, pos, prior_weights, proj_energy, projection_matrix, rect_position_vis, reg_energy, reg_filter, reg_window_edge, res_norms, residuals_pcg, sample_dim, sample_energy, sample_pos, sample_scale, sample_weights, samplesf, scale_filter, scale_step, scaleFactors, scores_fs_feat, search_area, seq, shift_samp, sig_y, target_sz, tracking_result, train_tracker, xl, xlf, xlf_proj, xlf_proj_perm, yf, yf_x, yf_y
...
%             set(fig_handle, 'Position', [100, 100, size(im,2), size(im,1)]);
            im_to_show=insertObjectAnnotation(im_to_show, 'rectangle', rect_position_vis, 'Face');
            imagesc(im_to_show);
            hold on;
...
%             end
            ...
            text(10, 10, num2str(seq.frame/seq.time,4), 'color', [0 1 1]);
            hold off;
